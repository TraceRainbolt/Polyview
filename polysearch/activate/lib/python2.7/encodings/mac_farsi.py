***REMOVED*** Python Character Mapping Codec mac_farsi generated from 'MAPPINGS/VENDORS/APPLE/FARSI.TXT' with gencodec.py.
...
class Codec(codecs.Codec***REMOVED***:
    ...
    def encode(self,input,errors='strict'***REMOVED***:
        return codecs.charmap_encode(input,errors,encoding_table***REMOVED***
...
class IncrementalEncoder(codecs.IncrementalEncoder***REMOVED***:
    def encode(self, input, final=False***REMOVED***:
        return codecs.charmap_encode(input,self.errors,encoding_table***REMOVED***[0***REMOVED***
...
decoding_table = (
    ...
    u'***REMOVED***'        #  0x29 -> RIGHT PARENTHESIS, left-right
    ...
    u'***REMOVED***'        #  0x5D -> RIGHT SQUARE BRACKET, left-right
    ...
    u'***REMOVED***'        #  0x7D -> RIGHT CURLY BRACKET, left-right
    u'~'        #  0x7E -> TILDE
    ...
    u'***REMOVED***'        #  0xA9 -> RIGHT PARENTHESIS, right-left
    ...
    u'\u06f0'   #  0xB0 -> EXTENDED ARABIC-INDIC DIGIT ZERO, right-left (need override***REMOVED***
    u'\u06f1'   #  0xB1 -> EXTENDED ARABIC-INDIC DIGIT ONE, right-left (need override***REMOVED***
    u'\u06f2'   #  0xB2 -> EXTENDED ARABIC-INDIC DIGIT TWO, right-left (need override***REMOVED***
    u'\u06f3'   #  0xB3 -> EXTENDED ARABIC-INDIC DIGIT THREE, right-left (need override***REMOVED***
    u'\u06f4'   #  0xB4 -> EXTENDED ARABIC-INDIC DIGIT FOUR, right-left (need override***REMOVED***
    u'\u06f5'   #  0xB5 -> EXTENDED ARABIC-INDIC DIGIT FIVE, right-left (need override***REMOVED***
    u'\u06f6'   #  0xB6 -> EXTENDED ARABIC-INDIC DIGIT SIX, right-left (need override***REMOVED***
    u'\u06f7'   #  0xB7 -> EXTENDED ARABIC-INDIC DIGIT SEVEN, right-left (need override***REMOVED***
    u'\u06f8'   #  0xB8 -> EXTENDED ARABIC-INDIC DIGIT EIGHT, right-left (need override***REMOVED***
    u'\u06f9'   #  0xB9 -> EXTENDED ARABIC-INDIC DIGIT NINE, right-left (need override***REMOVED***
    ...
    u'***REMOVED***'        #  0xDD -> RIGHT SQUARE BRACKET, right-left
    ...
    u'***REMOVED***'        #  0xFD -> RIGHT CURLY BRACKET, right-left
    u'\u0698'   #  0xFE -> ARABIC LETTER JEH
    u'\u06d2'   #  0xFF -> ARABIC LETTER YEH BARREE
***REMOVED***

### Encoding table
encoding_table=codecs.charmap_build(decoding_table***REMOVED***
