***REMOVED*** Python Character Mapping Codec iso8859_10 generated from 'MAPPINGS/ISO8859/8859-10.TXT' with gencodec.py.
...
decoding_table = (
    ...
    u'***REMOVED***'        #  0x29 -> RIGHT PARENTHESIS
    u'*'        #  0x2A -> ASTERISK
    u'+'        #  0x2B -> PLUS SIGN
    u','        #  0x2C -> COMMA
    u'-'        #  0x2D -> HYPHEN-MINUS
    ...
    u'***REMOVED***'        #  0x5D -> RIGHT SQUARE BRACKET
    ...
    u'***REMOVED***'        #  0x7D -> RIGHT CURLY BRACKET
    u'~'        #  0x7E -> TILDE
    u'\x7f'     #  0x7F -> DELETE
    u'\x80'     #  0x80 -> <control>
    u'\x81'     #  0x81 -> <control>
    ...
    u'\xd0'     #  0xD0 -> LATIN CAPITAL LETTER ETH (Icelandic***REMOVED***
    ...
    u'\xde'     #  0xDE -> LATIN CAPITAL LETTER THORN (Icelandic***REMOVED***
    u'\xdf'     #  0xDF -> LATIN SMALL LETTER SHARP S (German***REMOVED***
    ...
    u'\xf0'     #  0xF0 -> LATIN SMALL LETTER ETH (Icelandic***REMOVED***
    ...
    u'\xfe'     #  0xFE -> LATIN SMALL LETTER THORN (Icelandic***REMOVED***
