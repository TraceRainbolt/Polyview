***REMOVED*** Python Character Mapping Codec cp500 generated from 'MAPPINGS/VENDORS/MICSFT/EBCDIC/CP500.TXT' with gencodec.py.
...
decoding_table = (
    ...
    u'\xdf'     #  0x59 -> LATIN SMALL LETTER SHARP S (GERMAN***REMOVED***
    u'***REMOVED***'        #  0x5A -> RIGHT SQUARE BRACKET
    u'$'        #  0x5B -> DOLLAR SIGN
    u'*'        #  0x5C -> ASTERISK
    u'***REMOVED***'        #  0x5D -> RIGHT PARENTHESIS
    u';'        #  0x5E -> SEMICOLON
    ...
    u'\xf0'     #  0x8C -> LATIN SMALL LETTER ETH (ICELANDIC***REMOVED***
    u'\xfd'     #  0x8D -> LATIN SMALL LETTER Y WITH ACUTE
    u'\xfe'     #  0x8E -> LATIN SMALL LETTER THORN (ICELANDIC***REMOVED***
    ...
    u'\xd0'     #  0xAC -> LATIN CAPITAL LETTER ETH (ICELANDIC***REMOVED***
    u'\xdd'     #  0xAD -> LATIN CAPITAL LETTER Y WITH ACUTE
    u'\xde'     #  0xAE -> LATIN CAPITAL LETTER THORN (ICELANDIC***REMOVED***
    ...
    u'***REMOVED***'        #  0xD0 -> RIGHT CURLY BRACKET
