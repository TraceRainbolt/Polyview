***REMOVED*** Python Character Mapping Codec generated from 'PTCP154.txt' with gencodec.py.

Written by Marc-Andre Lemburg (mal@lemburg.com***REMOVED***.

(c***REMOVED*** Copyright CNRI, All Rights Reserved. NO WARRANTY.
(c***REMOVED*** Copyright 2000 Guido van Rossum.
...
decoding_map.update({
        ...
        0x00a1: 0x040e, #        CYRILLIC CAPITAL LETTER SHORT U (Byelorussian***REMOVED***
        0x00a2: 0x045e, #        CYRILLIC SMALL LETTER SHORT U (Byelorussian***REMOVED***
