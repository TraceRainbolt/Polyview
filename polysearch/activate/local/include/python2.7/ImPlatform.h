 ...
 *
 * Copyright (c***REMOVED*** Fredrik Lundh 1995-2003.
 */
...
/* VC++ 4.0 is a bit annoying when it comes to precision issues (like
   claiming that "float a = 0.0;" would lead to loss of precision***REMOVED***.  I
...
#pragma warning(disable: 4244***REMOVED*** /* conversion from 'float' to 'int' */
#endif
...
/* assume IEEE; tweak if necessary (patches are welcome***REMOVED*** */
