***REMOVED*** Python Character Mapping Codec generated from 'VENDORS/APPLE/ARABIC.TXT' with gencodec.py.
...
class Codec(codecs.Codec***REMOVED***:
    ...
    def decode(self,input,errors='strict'***REMOVED***:
        return codecs.charmap_decode(input,errors,decoding_table***REMOVED***
...
class IncrementalDecoder(codecs.IncrementalDecoder***REMOVED***:
    def decode(self, input, final=False***REMOVED***:
        return codecs.charmap_decode(input,self.errors,decoding_table***REMOVED***[0***REMOVED***
...
decoding_map.update({
    ...
    0x00b0: 0x0660,     #  ARABIC-INDIC DIGIT ZERO, right-left (need override***REMOVED***
    0x00b1: 0x0661,     #  ARABIC-INDIC DIGIT ONE, right-left (need override***REMOVED***
    0x00b2: 0x0662,     #  ARABIC-INDIC DIGIT TWO, right-left (need override***REMOVED***
    0x00b3: 0x0663,     #  ARABIC-INDIC DIGIT THREE, right-left (need override***REMOVED***
    0x00b4: 0x0664,     #  ARABIC-INDIC DIGIT FOUR, right-left (need override***REMOVED***
    0x00b5: 0x0665,     #  ARABIC-INDIC DIGIT FIVE, right-left (need override***REMOVED***
    0x00b6: 0x0666,     #  ARABIC-INDIC DIGIT SIX, right-left (need override***REMOVED***
    0x00b7: 0x0667,     #  ARABIC-INDIC DIGIT SEVEN, right-left (need override***REMOVED***
    0x00b8: 0x0668,     #  ARABIC-INDIC DIGIT EIGHT, right-left (need override***REMOVED***
    0x00b9: 0x0669,     #  ARABIC-INDIC DIGIT NINE, right-left (need override***REMOVED***
...
decoding_table = (
    ...
    u'***REMOVED***'        #  0x0029 -> RIGHT PARENTHESIS, left-right
    ...
    u'***REMOVED***'        #  0x005d -> RIGHT SQUARE BRACKET, left-right
    ...
    u'***REMOVED***'        #  0x007d -> RIGHT CURLY BRACKET, left-right
    u'~'        #  0x007e -> TILDE
    ...
    u'***REMOVED***'        #  0x00a9 -> RIGHT PARENTHESIS, right-left
    ...
    u'\u0660'   #  0x00b0 -> ARABIC-INDIC DIGIT ZERO, right-left (need override***REMOVED***
    u'\u0661'   #  0x00b1 -> ARABIC-INDIC DIGIT ONE, right-left (need override***REMOVED***
    u'\u0662'   #  0x00b2 -> ARABIC-INDIC DIGIT TWO, right-left (need override***REMOVED***
    u'\u0663'   #  0x00b3 -> ARABIC-INDIC DIGIT THREE, right-left (need override***REMOVED***
    u'\u0664'   #  0x00b4 -> ARABIC-INDIC DIGIT FOUR, right-left (need override***REMOVED***
    u'\u0665'   #  0x00b5 -> ARABIC-INDIC DIGIT FIVE, right-left (need override***REMOVED***
    u'\u0666'   #  0x00b6 -> ARABIC-INDIC DIGIT SIX, right-left (need override***REMOVED***
    u'\u0667'   #  0x00b7 -> ARABIC-INDIC DIGIT SEVEN, right-left (need override***REMOVED***
    u'\u0668'   #  0x00b8 -> ARABIC-INDIC DIGIT EIGHT, right-left (need override***REMOVED***
    u'\u0669'   #  0x00b9 -> ARABIC-INDIC DIGIT NINE, right-left (need override***REMOVED***
    ...
    u'***REMOVED***'        #  0x00dd -> RIGHT SQUARE BRACKET, right-left
    ...
    u'***REMOVED***'        #  0x00fd -> RIGHT CURLY BRACKET, right-left
...
encoding_map = {
    ...
    0x0660: 0x00b0,     #  ARABIC-INDIC DIGIT ZERO, right-left (need override***REMOVED***
    0x0661: 0x00b1,     #  ARABIC-INDIC DIGIT ONE, right-left (need override***REMOVED***
    0x0662: 0x00b2,     #  ARABIC-INDIC DIGIT TWO, right-left (need override***REMOVED***
    0x0663: 0x00b3,     #  ARABIC-INDIC DIGIT THREE, right-left (need override***REMOVED***
    0x0664: 0x00b4,     #  ARABIC-INDIC DIGIT FOUR, right-left (need override***REMOVED***
    0x0665: 0x00b5,     #  ARABIC-INDIC DIGIT FIVE, right-left (need override***REMOVED***
    0x0666: 0x00b6,     #  ARABIC-INDIC DIGIT SIX, right-left (need override***REMOVED***
    0x0667: 0x00b7,     #  ARABIC-INDIC DIGIT SEVEN, right-left (need override***REMOVED***
    0x0668: 0x00b8,     #  ARABIC-INDIC DIGIT EIGHT, right-left (need override***REMOVED***
    0x0669: 0x00b9,     #  ARABIC-INDIC DIGIT NINE, right-left (need override***REMOVED***
