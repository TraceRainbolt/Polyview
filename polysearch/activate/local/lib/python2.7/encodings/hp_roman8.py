***REMOVED*** Python Character Mapping Codec generated from 'hp_roman8.txt' with gencodec.py.

    Based on data from ftp://dkuug.dk/i18n/charmaps/HP-ROMAN8 (Keld Simonsen***REMOVED***
...
decoding_map.update({
        ...
        0x00a9: 0x02cb, #       MODIFIER LETTER GRAVE ACCENT (Mandarin Chinese fourth tone***REMOVED***
        ...
        0x00de: 0x00df, #       LATIN SMALL LETTER SHARP S (German***REMOVED***
        ...
        0x00e3: 0x00d0, #       LATIN CAPITAL LETTER ETH (Icelandic***REMOVED***
        0x00e4: 0x00f0, #       LATIN SMALL LETTER ETH (Icelandic***REMOVED***
        ...
        0x00f0: 0x00de, #       LATIN CAPITAL LETTER THORN (Icelandic***REMOVED***
        0x00f1: 0x00fe, #       LATIN SMALL LETTER THORN (Icelandic***REMOVED***
