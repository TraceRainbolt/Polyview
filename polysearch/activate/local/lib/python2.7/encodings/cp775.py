***REMOVED*** Python Character Mapping Codec cp775 generated from 'VENDORS/MICSFT/PC/CP775.TXT' with gencodec.py.
...
decoding_map.update({
    ...
    0x00e1: 0x00df,     #  LATIN SMALL LETTER SHARP S (GERMAN***REMOVED***
...
decoding_table = (
    ...
    u'\xdf'     #  0x00e1 -> LATIN SMALL LETTER SHARP S (GERMAN***REMOVED***
...
encoding_map = {
    ...
    0x00df: 0x00e1,     #  LATIN SMALL LETTER SHARP S (GERMAN***REMOVED***
