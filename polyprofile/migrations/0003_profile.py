...
class Migration(migrations.Migration***REMOVED***:
    ...
    dependencies = [
        ('polysearch', '0005_instructors'***REMOVED***,
        migrations.swappable_dependency(settings.AUTH_USER_MODEL***REMOVED***,
        ('polyprofile', '0002_auto_20170904_1932'***REMOVED***,
    ***REMOVED***
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checked', models.ManyToManyField(blank=True, to='polysearch.Sections'***REMOVED******REMOVED***,
