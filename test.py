...
class PolyviewProfileChecked(models.Model***REMOVED***:
    profile = models.ForeignKey(PolyviewProfile, models.DO_NOTHING***REMOVED***
    sections = models.ForeignKey('ScrapeSectionsFall2017', models.DO_NOTHING***REMOVED***

    class Meta:
        managed = False
        db_table = 'polyview_profile_checked'
        unique_together = (('profile', 'sections'***REMOVED***,***REMOVED***
...
class ScrapeInstructors(models.Model***REMOVED***:
...
class ScrapeNewCourses(models.Model***REMOVED***:
    ...
    course = models.ForeignKey(ScrapeCoursesFall2017, models.DO_NOTHING***REMOVED***
    ...
    rating = models.DecimalField(max_digits=3, decimal_places=2, blank=True, null=True***REMOVED***
    sec_group = models.IntegerField(***REMOVED***

    class Meta:
        managed = False
        db_table = 'scrape_new_courses'
...
class ScrapeSectionsFall2017(models.Model***REMOVED***:
    ...
    sec_num = models.SmallIntegerField(***REMOVED***
    type = models.CharField(max_length=3, blank=True, null=True***REMOVED***
    instructor = models.ForeignKey(ScrapeInstructors, models.DO_NOTHING, db_column='instructor', blank=True, null=True***REMOVED***
    available = models.SmallIntegerField(blank=True, null=True***REMOVED***
    taken = models.SmallIntegerField(blank=True, null=True***REMOVED***
    waiting = models.SmallIntegerField(blank=True, null=True***REMOVED***
    status = models.CharField(max_length=20, blank=True, null=True***REMOVED***
